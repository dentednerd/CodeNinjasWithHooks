...
highlightElement:w,
highlightElement:e=>(X("10.7.0","highlightElement will be removed entirely in v12.0"),
...
e["before:highlightElement"]&&!e["before:highlightElement"]&&(e["before:highlightElement"]=t=>{
e["before:highlightElement"](Object.assign({block:t.el},t))
}),e["after:highlightElement"]&&!e["after:highlightElement"]&&(e["after:highlightElement"]=t=>{
e["after:highlightElement"](Object.assign({block:t.el},t))})})(e),s.push(e)}
...
;hljs.registerLanguage("bash",e)})();/*! `javascript` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict"
